 ...
 */
angular.module('app')
  .controller('AppCtrl', ['$scope', '$localStorage', '$window', '$document', '$location', '$rootScope', '$cookies', '$timeout', '$mdSidenav', '$mdColorPalette', '$anchorScroll', '$mdDialog', 'OAuthToken', 'config',
    function (             $scope,   $localStorage,   $window,   $document,   $location,   $rootScope,   $cookies,   $timeout,   $mdSidenav,   $mdColorPalette,   $anchorScroll,    $mdDialog,   OAuthToken,   config) {
      ...
      if (typeof $rootScope.userActive === 'undefined'){
        $rootScope.userActive = $cookies.getObject('user');
      }
